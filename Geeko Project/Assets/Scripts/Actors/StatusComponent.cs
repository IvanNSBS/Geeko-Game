...
public class StatusComponent : MonoBehaviour
{
    ...
    public void SetMaxHealth(float newhealth) { m_MaxHealth = newhealth; }
    ...
    public void Heal(float amount) { m_CurrentHealth += amount; Mathf.Clamp(m_CurrentHealth, 0.0f, m_MaxHealth); }
